...
def index(request):
    ...
    if 'latitud' in request.GET:
        ...
        if latitud:
            ...
            response = requests.post('http://pi1-eafit-acua.azurewebsites.net/formularioss/', args)
    ...
    response = requests.get('http://pi1-eafit-acua.azurewebsites.net/formularioss/')
